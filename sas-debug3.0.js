...
//下一步
Main.prototype.next_tick = function(i, t, count, parents) {
  if (count[0] === count[1]) {
    if (parents) {
      parents[2][1]++;
...
//程序结束
Main.prototype._end = function() { //over
...
var terminalLog = function(str, style) {
  var prefix, suffix = 39;
  switch (style) {
    case "white":
      prefix = 1;
      suffix = 22;
  ...
  console.log('\u001b[' + prefix + 'm' + str + '\u001b[' + suffix + 'm');
}
sas.log = (typeof window !== 'undefined') ? console.log : terminalLog;
